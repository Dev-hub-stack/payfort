...
class PayfortIntegration
{
    ...
    public $gatewayHost        = GATEWAY_HOST;
    public $gatewaySandboxHost = GATEWAY_SANDBOX_HOST;
    public $language           = 'en';
    /**
...
//            $return_url = WEB_URL . '/thank-you';
    ...
    public function merchantPageNotifyFort($fortParams)
    {
        ...
        $postData      = array(
            ...
            'amount'              => $this->amount == 1 ? 100 : $this->convertFortAmount($this->amount, $this->currency),
            'currency'            => strtoupper($this->currency),
